...
The search script lives inside this skill's own directory. It is vendored into this repository, so the paths below are relative to the repo root (`/home/user/kongrave-publisher`) — run them from there, or prefix them with the repo root:
